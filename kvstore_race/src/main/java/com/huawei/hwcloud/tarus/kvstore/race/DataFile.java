...
public class DataFile {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(DataFile.class);
...
//    private final LRUCache pageCache;
    ...
    private boolean dioSupported;

    public DataFile(String fileName, int pageSize, int maxCacheSize) throws IOException {
    ...
    private ByteBuffer page(long position) throws IOException {
