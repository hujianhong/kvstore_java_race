...
public class DataFile {
	...
	public final void init(final String path) throws IOException{
		this.path = path;
	...
	public final int append(final String info) throws IOException{
		return append(BufferUtil.stringToBytes(info));
	}

	public final int append(final String key, final byte[] val) throws IOException{
	...
	public final int read(final int offset, final int size, final Ref<String> out) throws IOException{
	...
	public final int readKV(final int offset, final Ref<String> key, final Ref<byte[]> val) throws IOException{
    ...
    //utils
    public final static boolean remove(final String dir) throws IOException{
    ...
    public final static int scanDir(final String dir, final boolean create_if_no_exist, final List<String> files) throws IOException{
